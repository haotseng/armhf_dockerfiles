## ARMHF Apache2 with SSL and PHP5 support

---

## How to build image :

    docker build -t ebspace/armhf-apache-php:latest .
...
"It works!", and browse to the host's IP address using http or https:
    ...
    docker run -p 80:80 -p 443:443 -d ebspace/armhf-apache-php:latest


Serving actual content with SSL support:

    docker run -p 80:80 -p 443:443 -v /home/jdoe/mysite/:/var/www/html/ -d ebspace/armhf-apache-php:latest

Without SSL support:

    docker run -p 80:80 -v /home/jdoe/mysite/:/var/www/html/ -d ebspace/armhf-apache-php:latest

    
Using non-standard ports:

    docker run -p 8080:80 -p 8443:443 -v /home/jdoe/mysite/:/var/www/html/ -d ebspace/armhf-apache-php:latest
